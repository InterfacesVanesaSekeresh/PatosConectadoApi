 ...
 */
function DuckDetailsDocusaurus({ pato }) {
  if (!pato) {
    return <p>Pato no encontrado</p>;
  }

  return (
    <article className="contenedor__detalle">
      
      <header>
        <h1 className="contenedor__titulo text-center">{pato.nombre}</h1>
      </header>
      ...
      <section>
        <p className="contenedor__texto-largo">{pato.categoria}</p>
...
export default DuckDetailsDocusaurus;
